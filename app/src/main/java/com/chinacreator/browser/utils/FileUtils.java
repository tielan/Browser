...
public class FileUtils {
    ...
    public static File createRandomFile(MultipartFile file) {
        ...
        return new File(BrowserApplication.getInstance().getRootDir(), uuid + "." + extension);
    }

    public static File getRandomPath() {
        String uuid = UUID.randomUUID().toString();
        return new File(BrowserApplication.getInstance().getRootDir(), uuid);
    }
